...
public class ColorTemperatureGenerator {
    ...
    public static void main(String[] args) throws IOException {
        generateColorDesciption().toJSONFile(new File("colorDescription.json"));
        System.out.println(generateColorDesciption().toJSON());
    }

    public static RangeActuator generateColorDesciption() throws JsonProcessingException {
        RangeActuator aRange = new RangeActuator("color", 2700, 5500, 3000)
                .hasControl(new Control("set-default", 3400, true))
                .hasControl(new Control("increase-100", 100, false))
                .hasControl(new Control("decrease-100", 100, false));
        return aRange;
//        
