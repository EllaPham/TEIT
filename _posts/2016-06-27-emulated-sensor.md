...
Data format configuration of Emulated Sensor
...
# 6. Scope & Development orientation
...
Input Adaptor has responsibility in transforming data from a variety of formats (e.g. csv, json, xml,...) to only format in Map<String,String>. This map is input data for Emulated Sensor. Now, we have accomplished: 
